...
from sqlalchemy import Column, Double, Enum, ForeignKeyConstraint, Index, Integer, PrimaryKeyConstraint, String
...
class Properties(Base):
    ...
    Type = mapped_column(Enum('House', 'Apartment', 'Condo', name='type_enum'))
...
class Transactions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['ClientID'], ['clients.ClientID'], name='transactions_ClientID_fkey'),
    ...
    clients: Mapped[Optional['Clients']] = relationship('Clients', back_populates='transactions')
